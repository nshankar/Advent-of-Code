...
def main():
    """
    Solution from https://old.reddit.com/r/adventofcode/comments/18pnycy/2023_day_24_solutions/kev3buh/
    ...
    """
    puzzle = (
        np.fromregex("input.txt", r"-?\d+", [("", int)]).astype(int).reshape(-1, 2, 3)
    )
    three = puzzle[:3]
